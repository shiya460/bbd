...
<body class="text-center">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main role="main" class="inner cover">
            <h1 class="cover-heading">Dr.Ram Mahohar Lohia</h1>
            <h2 class="cover-heading">Awadh University Ayodhya</h2>
        ...
        <footer class="mastfoot mt-auto">
            <div class="inner">
              <p>Developed by <a href="http://github.com/debiprasad">Softpro india</a>.</p>
            </div>
        </footer>
    </div>
